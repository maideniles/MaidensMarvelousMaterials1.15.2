...
public abstract class CrabappleTreeGen<T extends BaseTreeFeatureConfig> extends Feature<T> {


    public CrabappleTreeGen(Function<Dynamic<?>, ? extends T> configFactoryIn) {
