...
public class GrowingLimeLeaves extends BushBlock implements IGrowable {
    ...
    public GrowingLimeLeaves(Block.Properties properties) {
    ...
    protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == Blocks.AIR ||block.isIn(BlockTags.LOGS) || block == Blocks.DIRT || block == ModBlocks.growingLimeLeaves.get()|| block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.FARMLAND || block == Blocks.SAND || block.isIn(BlockTags.LEAVES);
    }
